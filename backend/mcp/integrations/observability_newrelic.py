...
def _format_query(template: str, service: str, environment: str) -> str:
    """Fill appName/environment placeholders into a New Relic NRQL template.

    Values are restricted to a safe character set to prevent NRQL injection
    through crafted connector configuration.
    """
